...
def display_info(name, play_status):
    ...
    draw.text((34-len(next_stream)*0.75, 224), f'[{prev_stream}]', font=font, fill=(100, 100, 100))
    draw.text((162-len(next_stream)*1.5, 224), f'[{next_stream}]', font=font, fill=(100, 100, 100))
    safe_display(image)
